...
** What is Emacs ?
   ...
   |Challenge: which Emacs properties can you deduce from this image alone?[fn:11] |
...
** How will we use Emacs?
   ...
   * SHELL to build and run code.
   ...
   In the Beginning was the Command Line (1998)[fn:7]
   #+end_quote           
...
** What about Emacs' famously "steep learning curve" ?
   ...
   justified that goes into improving your meta skills[fn:8] in this area.
...
** Create sample notebook
   ...
   Check out [[./babel_c.org]] for examples with C code blocks[fn:9].
...
[fn:11](1) Emacs has versions (at the time the screenshot was taken:
...
[fn:7]Neal Stephenson is a sci-fi author who also coined the term
...
[fn:8]"Meta skills" are transferable skills that you learn, or
...
[fn:9]This link also shows you how to link notebooks. You can set a
...
[fn:10]The best way is to find the folder in the file explorer and copy
the address as text:
[[./img/address.png]]
