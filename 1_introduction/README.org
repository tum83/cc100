...
** Lightning fast and terribly tiny
   ...
   * Some very specialized languages are even faster
   ...
   /Images source: [[https://github.com/kostya/benchmarks][Kostya benchmark, GitHub, Nov 2021]]/
...
* Why are we not just learning C++?
  ...
  * C is simpler, smaller, and faster
  ...
  However: Bjarne Stroustrup said 2011 that "[[https://youtu.be/KlPC3O1DVcg][C is obsolete]]"[fn:6],
  while Linus Torvalds wrote (in 2007) that "[[http://harmful.cat-v.org/software/c++/linus][C++ is a horrible
  language]]"[fn:7].
...
* Summary
  ...
  * C is small, simple, fast, and close to the computer
  * Written
