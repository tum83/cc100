...
** Why are we using it?
   ...
   * Gain access to the course materials
   * Upload assignments
   *
...
** What will you have to do?
   ...
   * Pick a username: first and last name, e.g. ~DonaldTrump~
   * [[https://docs.github.com/en/get-started/quickstart/hello-world][Complete the "Hello World" exercise]] (FAQ)
     UPLOAD TO THIS GITHUB REPO...
     https://github.com/birkenkrahe/cc100/tree/main/2_installation/github_assignment

     * You send me your GitHub username so that I can add you as a
...
** What else can you do?
   ...
   * You can submit issues to the repository
   * You can participate in [[https://github.com/birkenkrahe/cc100/discussions][discussions]]
   * You can add to the [[https://github.com/birkenkrahe/cc100/wiki][wiki]]
