...
** Technology  
  ...
  |---------------------------------------------------------+----------+----------------|
  | C source code needs to be written and edited            | editor   | [[https://www.gnu.org/software/emacs/][GNU Emacs]], vi  |
  | C source code needs to be compiled, linked and debugged | compiler | [[https://gcc.gnu.org/][GCC]], Clang     |
  | C object code needs to be run                           | shell    | [[https://www.gnu.org/software/bash/][GNU bash]], [[https://fishshell.com/][fish]] |
