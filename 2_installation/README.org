...
** What else can you do?
   ...
   * You can add to the [[https://github.com/birkenkrahe/cc100/wiki][wiki]] (e.g. comments and links to interesting
     resources)
   * You can install the [[https://github.com/mobile][mobile app]] on your smartphone[fn:6]
...
* Emacs for C programming
  ...
  A great, relatively new resource to look at (for free, at first)
  that uses the REPL concept, is [[https://repl.it][repl.it]]. See image below.
...
** What is Emacs ?
   ...
   | Ancient software             | Written 1976, released in 1985[fn:4]   |
...
[fn:4]Written in 1976 by Richard Stallman, who then tinkered with it
